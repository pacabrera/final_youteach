...
<br>
             ...
             <div style="text-align: center;">   
              ...
              <div id="rndmBtn" class="startbtn">
                <form action="{{route('grade-categ')}}" method="POST">
                  <input type="hidden" value="{{$myClass->class_id}}" name="class_id">
                <input type="submit" ' class="btn red" style="
                    border-radius: 5px;
                    padding: 10px 20px;
                    font-size: 14px;
                    ...
                    width: 200px;" value="Start Graded Recitation">
              </div>
